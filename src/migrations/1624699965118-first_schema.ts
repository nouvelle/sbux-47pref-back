...
export class firstSchema1624699965118 implements MigrationInterface {
    name = 'firstSchema1624699965118'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "store" ("id" SERIAL NOT NULL, "store_name" text NOT NULL, "address" text NOT NULL, "office_hour" text NOT NULL, "wifi" text NOT NULL, "lat" numeric, "lng" numeric, "location_type" text, "listed" boolean, "transaction_date" TIMESTAMP WITH TIME ZONE NOT NULL, "pref_id" integer, CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "visited_date" TIMESTAMP WITH TIME ZONE NOT NULL, "image" text, "comments" text, "author" text NOT NULL, "secretkey" text, "snshandle" text, "tag" text, "pref_id" integer, "store_id" integer, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "store" ADD CONSTRAINT "FK_92b20dfabdafb2d42af748641ba" FOREIGN KEY ("pref_id") REFERENCES "pref"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_143305a0da700e1d6b5bd3e0d11" FOREIGN KEY ("store_id") REFERENCES "store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "store" DROP CONSTRAINT "FK_92b20dfabdafb2d42af748641ba"`);
